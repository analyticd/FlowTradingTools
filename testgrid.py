...
class InforalgoControlPanel(wx.Panel):
    def __init__(self, parent, table = None, bdm = None):
        ...
        self.inforalgoGrid.EnableEditing = True
        #self.inforalgoGrid.Bind(gridlib.EVT_GRID_EDITOR_CREATED,self.onCellEdit)
        self.inforalgoGrid.Bind(wx.EVT_KEY_DOWN, self.onEditorKey)
    ...
    def onEditorKey(self, event):
        ...
        #     for i in range(0,self.tabCounter):
        #         self.inforalgoGrid.MoveCursorLeft(False)
        #     self.tabCounter = 0
        # else:
        #     pass
        if keycode == wx.WXK_WINDOWS_MENU:#395
            print 'menu key'
        print keycode
        event.Skip()
...
class InforalgoControlFrame(wx.Frame):
    def __init__(self):
        ...
        self.panel=InforalgoControlPanel(self, table=None)
